...
require 'azure_media_service/model/channel'
require 'azure_media_service/model/program'
require 'azure_media_service/model/streaming_endpoint'
...
require 'azure_media_service/model/operation'
